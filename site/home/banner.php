                        ...
                        <div class="col-sm-6">
                            <div class="banner banner-overlay">
                                ...
                                <div class="banner-content banner-content-center">
                                    ...
                                    <a href="women-product" class="btn btn-outline-white banner-link underline">Shop Now</a>
                        ...
                        <div class="col-sm-6">
                            <div class="banner banner-overlay">
                                ...
                                <div class="banner-content banner-content-center">
                                    ...
                                    <a href="men-product" class="btn btn-outline-white banner-link underline">Shop Now</a>
                                </div><!-- End .banner-content -->
                            </div><!-- End .banner -->
                        </div><!-- End .col-sm-6 -->
                    </div><!-- End .row -->
