<div class="container">
                <h2 class="title text-center mb-4 pt-4">Child's New Arrivals</h2><!-- End .title text-center -->

                <div class="products">
                    <div class="row justify-content-center">
                    <?php 
                            $result=Product::get_products_child();
                ...
                <div class="more-container text-center mt-2">
                    <a href="child-product" class="btn btn-outline-dark-2 btn-more"><span>show more</span></a>
